...
<div style="padding: 70px 550px 10px">
    <form   method="post" action="querybook.html" class="form-inline"  id="searchform">
        <div class="input-group" style="top:50px">
...
<c:if test="${!empty succ}">
    <div class="alert alert-success alert-dismissable" style="height: 50px; z-index: 9999">
...
<c:if test="${!empty error}">
    <div class="alert alert-danger alert-dismissable" style="height: 50px; z-index: 9999">
        <button type="button" class="close" data-dismiss="alert"
                aria-hidden="true">
            &times;
        </button>
...
<div class="panel panel-default" style="width: 90%;margin-left: 5%; align-all: center; position: absolute; top:67px">
